...
class Login:
    ...
    def __init__(self,root):
        ...
        img1=img1.resize((1366,790),Image.LANCZOS)
        ...
        login_frame.place(x=330, y=100, width=660, height=500)
        ...
        email = Label(login_frame, text="Email", font=("times new roman", 18, "bold"), bg="white", fg="navyblue").place(x=150, y=150)
        self.txtuser = Entry(login_frame, font=("times new roman", 15), bg="lightgray")
        self.txtuser.place(x=150, y=180, width=350, height=35)

        pass_ = Label(login_frame, text="Password", font=("times new roman", 18, "bold"), bg="white", fg="navyblue").place(x=150, y=250)
        self.txtpwd = Entry(login_frame, font=("times new roman", 15), bg="lightgray")
        self.txtpwd.place(x=150, y=280, width=350, height=35)

        btn_reg = Button(login_frame, cursor="hand2", command=self.reg, text="Register an account", font=("times new roman", 14), bg="white", bd=0, fg="navyblue").place(x=150, y=330)

        btn_forgetpwd = Button(login_frame, cursor="hand2", command=self.forget_pwd, text="Forget password", font=("times new roman", 14), bg="white", bd=0, fg="navyblue").place(x=400, y=330)
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(user='root', password='Dee@Reg45',host='localhost',database='face_recognizer',port=3306)
    ...
    def forget_pwd(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.combo_security["values"]=("Select","Date of Birth","Nick Name","Others")
...
#         img1=Image.open(r"img\face_recog_bg.jpg")
...
#     # #student Bottom
#         img4=Image.open(r"E:\face recog\face recog\img\std1.jpg")
...
#         img5=Image.open(r"E:\face recog\face recog\img\det1.jpg")
...
#     #Attendance button
#         img6=Image.open(r"E:\face recog\face recog\img\att.jpg")
...
#     #HelpDesk button
#         img7=Image.open(r"E:\face recog\face recog\img\hlp.jpg")
...
#     #Train face button
#         img8=Image.open(r"E:\face recog\face recog\img\Traindata.jpg")
...
#     #Photos face button
#         img9=Image.open(r"E:\face recog\face recog\img\Photos.jpg")
...
#     #Exit button
#         img11=Image.open(r"E:\face recog\face recog\img\exit.png")
