...
class Register:
    def __init__(self,root):
        ...
        bg_image = bg_image.resize((1366, 720), Image.ADAPTIVE)  # Resize the image to fit the window
 ...
 #bg image
        ...
        frame.place(x=400, y=100, width=670, height=480)  # Adjust the position and size of the frame as needed
